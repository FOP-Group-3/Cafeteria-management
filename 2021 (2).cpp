...
void Main_Menu() { 
    cout<<"...... RESTAURANT........\n";
    cout<<"the daily specials are wine and pizza";
   cout<<"Enter 1 To order food\n";
    cout<<"Enter 2  to display daily sales report\n";
       
     
    }
         
void prepaid_card(float b) {
    string p_word;
    float in,tip,y;
    char choice;
...
choose:
        ...
        cout<<"Your card has declined please provide with another \n";
    }
